...
- Web: route generation, strict TypeScript, lint, 19 Vitest tests, the optimized Next.js production build, and browser inspection of registration and recovery pass locally.
