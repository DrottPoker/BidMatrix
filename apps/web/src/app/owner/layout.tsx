  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="border-b border-amber-300 bg-amber-50 px-5 py-2 text-center text-xs font-semibold text-amber-950">
        <span className="inline-flex items-center gap-2"><AlertTriangle size={14} />Foundation F0 is draft-only. External actions and remote Git operations are disabled.</span>
      </div>
