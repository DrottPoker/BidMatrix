...
export const foundationMetrics: FoundationMetric[] = [
  { label: "Release target", value: "F0", detail: "Foundation gate complete" },
  { label: "Architecture decisions", value: "8", detail: "Accepted and recorded" },
...
export const foundationPhases: FoundationPhase[] = [
  { id: "phase-0", number: "00", title: "Decisions and boundaries", status: "Complete", outcome: "Scope, runtime choices, trust boundaries, and preserved prototype direction are documented.", deliverables: ["Repository assessment", "Eight ADRs", "Runtime baseline"] },
  ...
  { id: "phase-2", number: "02", title: "Authoritative domain", status: "Complete", outcome: "Seven migrations establish tenant-aware domain, audit, controls, approvals, agents, and sandbox state.", deliverables: ["PostgreSQL model", "Forced RLS", "Development seed"] },
  ...
  { id: "phase-4", number: "04", title: "Analysis intake", status: "Complete", outcome: "PDF files are validated, hashed, quarantined, and routed to durable manual review without fake extraction.", deliverables: ["PDF quarantine", "Temporal intake", "Manual review"] },
  ...
  { id: "phase-9", number: "09", title: "Release gate", status: "Complete", outcome: "Automated, security, dependency, documentation, Compose, and essential end-to-end gates are recorded.", deliverables: ["Threat model", "Runbooks", "F0 verification"] },
];
