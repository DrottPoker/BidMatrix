...
public sealed class ContractSurfaceTests(DatabaseFixture database)
{
    ...
    [
        ...
        ("get", "/owner/v1/account-recovery-links"),
        ("post", "/owner/v1/account-recovery-links"),
        ("post", "/owner/v1/account-recovery-links/{recoveryId}/revoke"),
        ("get", "/owner/v1/tasks"),
        ("post", "/owner/v1/tasks"),
